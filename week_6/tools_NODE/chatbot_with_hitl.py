...
def purchase_stock(symbol: str, quantity: int) -> dict:
    ...
    """
    Simulate purchasing a given quality of a stock symbol.
    
    HUMAN_ IN_THE_LOOP:
    Before confirming the purchase, this tool will interrupt
    and wait fora  human decision( "yes" / anything else).
    """

    #this pause the graph and returns control to the caller >>>
...
graph.add_conditional_edges("chat_node", route_tools)
